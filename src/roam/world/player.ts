...
import { CapsuleGeometry, Mesh, MeshNormalMaterial, AnimationMixer, Scene, Vector3 } from 'three';
...
export class Player extends EventEmitter {
  ...
  init() {
    ...
    this.model.scene.position.set(0, -0.5, 0.2);
    ...
    this.mesh.material.transparent = true; // 将材质设置为透明
    this.mesh.material.opacity = 0.2;
    this.mesh.add(this.model.scene);
    this.onFloor = true;
